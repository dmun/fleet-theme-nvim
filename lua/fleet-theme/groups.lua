...
function M.setup()
    ...
    local groups = {
		...
		CmpItemKindText = { fg = palette.dark },
		CmpItemKindMethod = { fg = palette.red, bold = true },
		CmpItemKindConstructor = { link = "@type" },
		CmpItemKindFunction = { fg = palette.red, bold = true },
		...
		CmpItemKindUnit = { link = "Function" },
		CmpItemKindClass = { link = "@type" },
		CmpItemKindVariable = { fg = palette.yellow, bold = true },
		CmpItemKindFile = { fg = palette.light_blue },
		CmpItemKindInterface = { link = "@lsp.type.interface" },
		CmpItemKindColor = { fg = palette.red },
		CmpItemKindReference = { fg = palette.red },
		CmpItemKindEnumMember = { link = "@lsp.type.enumMember" },
		CmpItemKindStruct = { link = "@type" },
		CmpItemKindValue = { fg = palette.yellow },
		CmpItemKindEvent = { fg = palette.light_blue },
